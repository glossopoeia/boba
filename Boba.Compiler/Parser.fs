...
let prodIdxToNonTerminal (prodIdx:int) = 
  match prodIdx with
    ...
    | 346 -> NONTERM_list_pattern 
    | 347 -> NONTERM_list_pattern 
    | 348 -> NONTERM_vector_pattern 
    | 349 -> NONTERM_slice_pattern 
    | 350 -> NONTERM_record_pattern 
